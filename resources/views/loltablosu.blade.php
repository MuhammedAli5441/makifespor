            ...
            <main class="container-fluid px-3 px-md-4">
                ...
                <div class="card mb-4">
                    <div class="card-header bg-info text-white">
                        ...
                        Sıradaki League of Legends Maçları
                    </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-bordered table-striped text-center align-middle">
                            ...
                            <tbody>
                                @php
                                $siraliLol = $takimlar->filter(fn($t)=>in_array('League of Legends',$t->oyunlar??[]))
                                ->sortByDesc('puan')
                                ->values();
                                @endphp
                                @forelse ($siraliLol as $index => $takim)
                                <tr
                                    class="{{ $index<4 ? 'border-left-green' : ($index<12 ? 'border-left-orange' : '') }}">
                                    <td>{{ $index+1 }}</td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted">LoL takım kaydı yok</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
