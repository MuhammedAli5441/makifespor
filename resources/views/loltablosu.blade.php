            ...
            <div class="card mb-4">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @php
                                $valorantTakimlar = $takimlar->filter(fn($t) => in_array('League of Legends', $t->oyunlar ?? []));
                            @endphp

                            @foreach ($valorantTakimlar as $takim)
                                @php
                                    $sira = $loop->iteration;
                                    $rowClass = '';
                            ...
                            @if($valorantTakimlar->isEmpty())
                                <tr>
                                    <td colspan="4" class="text-center text-muted">Valorant takım kaydı bulunamadı</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
